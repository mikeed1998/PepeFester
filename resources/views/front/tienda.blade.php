                            ...
                            <div class="card border-0">
                                <div class="circulo-img">
                                     <div class="icono" style="
                                        background-image: url('{{ asset('img/photos/pepe_categorias/'.$cate->icono) }}');
                                    "></div>
                                </div>
                            </div>
...
<section class="sub-categorias_tienda py-4 border-0" data-aos="zoom-in" style="background-color: var(--fondo-tienda);">
    <div class="container-fluid">
        <div class="row bg-white">
            <div class="col position-relative shadow z-3">
                <div class="col-12">
                    <div class="row">
                        <div class="categorias mt-4">
                            @foreach ($categorias as $cate)
                                <div class="dropdown">
                                    <a href="#" class="py-5" id="categoria-{{ $cate->id }}" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="col-12 position-relative d-flex justify-content-center" style="margin-bottom: 100px;">
                                            <div class="card border-0">
                                                <div class="circulo-img">
                                                    <div class="icono" style="background-image: url('{{ asset('img/photos/pepe_categorias/'.$cate->icono) }}');"></div>
                                                </div>
                                            </div>
                                            <div class="col-10 mx-auto text-center position-absolute top-100 texto-circulo">
                                                {{ $cate->categoria }}
                                    ...
                                    <ul class="dropdown-menu row w-100 z-3" style="max-height:5.5rem; overflow:auto;" aria-labelledby="categoria-{{ $cate->id }}" >
                                        @foreach ($subcategorias as $sc)
                                            @if ($sc->categoria == $cate->id)
                                                <li><a class="dropdown-item filter-option texto-circulo2" style="line-height: 1; font-size: 1rem;" href="#" data-filter=".categoria-{{ $sc->id }}">{{ $sc->subcategoria }}</a></li>
                                            @endif     
                                        @endforeach
                                    </ul>
                                </div>
...
<section class="sub-productos_tienda pb-5" data-aos="zoom-in-down" style="background-color: var(--fondo-tienda);">
    <div class="container-fluid">
        ...
        <div class="row js-filter">
            ...
            @foreach ($productos as $prod)
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-9 col-xs-12 col-12 mt-5 ps-3 pe-3 mx-auto mb-5 categoria categoria-{{ $prod->subcategoria }}">
                    <div class="card carta bg-white" style="border-color: var(--azul-titulos); border-top-left-radius: 32px; border-bottom-left-radius: 32px; border-top-right-radius: 32px; border-bottom-right-radius: 0;">
                        <img src="{{ asset('img/photos/pepe_productos/'.$prod->imagen) }}" alt="" class="img-fluid img-producto m-0 p-2" style="border-top-left-radius: 32px; border-bottom-left-radius: 0; border-top-right-radius: 32px;">
                            ...
                            <div class="row">
                                <div class="col-xxl-8 col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-9 col-9 mx-auto text-start text-secondary fs-5">
                                    @foreach ($subcategorias as $subcate)
                                        @if ($prod->subcategoria == $subcate->id)
...
<script>
    $(document).ready(function() {
        ...
        $('.filter-option').on('click', function(e) {
            ...
            // Obtén el texto directamente desde el enlace clicado
            var categoriaNombre = $(this).text().trim();
            console.log('Valor de categoriaNombre:', categoriaNombre);
