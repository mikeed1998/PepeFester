        ...
        <div class="col">
            ...
            <script>
                ...
                var customIcon = L.icon({
                    iconUrl: '{{ asset("img/design/pepe1.png") }}',
                    iconSize: [32, 32],  // Tamaño del icono
                    iconAnchor: [16, 32],  // Punto de anclaje del icono (generalmente la mitad de iconSize)
                    popupAnchor: [0, -32]  // Punto de anclaje del pop-up relativo al icono
                });

                // Crea un marcador con el icono personalizado
                var marker = L.marker([20.630635040741133, -103.40638033868349], { icon: customIcon }).addTo(mymap);
