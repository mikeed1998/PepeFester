                            ...
                            <div class="col position-relative py-3 mx-auto">
                                <div class="row">
                                    ...
                                    <div class="col-8 position-relative text-center">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="text" class="form-control editar_text_seccion_global editarajax" data-url="{{route('config.seccion.textglobalseccion')}}" data-table="PFPuntoVenta" data-campo="mapa" data-id="{{ $pv->id }}" placeholder="link del mapa">
                                            </div>
                                        </div>
                                    </div>
                                </div>
