                    ...
                    <div class="col-12 ">
                        <div class="col-12 my-3 mt-2 d-flex px-4">
                            ...
                            <div class="col-6 px-5">
                                ...
                                <input type="text" class="form-control usuario_txt_change" data-id-cliente="{{$user->id}}" data-campo="telefono" aria-describedby="" value="{{$user->telefono}}" placeholder="Ingresa mínimo 8 digitos" required>
                            </div>
                        </div>
                        <div class="col-12 my-3 mt-2 d-flex px-4">
                            <div class="col-6 px-5">
