...
class FrontController extends Controller
{
	...
	public function index(){
		...
		$presentacion = PFProductoPresentacionPepes::all();
		...
		return view('front.index', compact('elements', 'pagina', 'categorias', 'subcategorias', 'productos', 'slider_principal', 'soluciones', 'proyectos', 'cont', 'elements_proyectos', 'elements_contacto', 'config', 'presentacion'));
	}
	...
	public function tienda() {
		...
		return view('front.tienda', compact('pagina', 'categorias', 'subcategorias', 'productos', 'elements', 'config', 'presentacion'));
	}

	public function producto($id) {
		$categorias = PFSubcategoriaPepes::all();
		$producto = PFProductoPepes::find($id);
		$productos = PFProductoPepes::all();
		$producto_p = PFProductoPresentacionPepes::all();
		...
		return view('front.tienda_detalle', compact('id', 'pagina', 'subcategorias', 'presentacion', 'producto', 'categorias', 'productos', 'producto_p', 'gale', 'config'));
	}
