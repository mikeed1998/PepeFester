...
class ProductoController extends Controller
{
	...
	public function viewProduct($id){
		...
		$subcategoria = PFSubcategoriaPepes::find($producto->categoria);
		$subcategorias = PFSubcategoriaPepes::all();
		// $color = colores::find($producto->color);
		// $colores = colores::all();
		return view('configs.secciones.productosd',compact('producto','subcategoria','subcategorias'));
	}
	...
	public function updateIni(Request $request){
		$producto = PFProductoPepes::find($request->id);
		$productos_count = count(PFProductoPepes::where('inicio',1)->get());
