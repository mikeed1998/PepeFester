...
class PayPalController extends Controller
{
    ...
    // {
    //     $apiKey = 'e043596245d24c03bbfd372c8e5939e4'; // Reemplaza con tu clave de API de Open Exchange Rates
    //     $baseCurrency = 'USD';
    //     $targetCurrency = 'MXN';

    //     $client = new Client();
    //     $response = $client->get("https://open.er-api.com/v6/latest/{$baseCurrency}?apikey={$apiKey}");
    ...
    //     // Obtén el tipo de cambio de USD a MXN
    //     $tipoCambio = $data['rates'][$targetCurrency];
    ...
    public function procesarPagoPayPal(Request $request){
        ...
        $uriOrder = 'https://api.sandbox.paypal.com/v2/checkout/orders';
